...
typedef enum : NSUInteger {
    ...
    ProOvalVoice, // chụp ảnh chân dung xa gần kết hợp đọc số
...
- (void) presentPopupCloseSDKBackgroundColor:(UIColor *)backgroundColor textColorContent:(UIColor *)textColorContent titleColorButton:(UIColor *)titleColorButton backgroundColorButton:(UIColor *)backgroundColorButton backgroundColorLine:(UIColor *)backgroundColorLine;
