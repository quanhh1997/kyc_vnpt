...
- (void) gotoPopupCloseSDKBackgroundColor:(UIColor *)backgroundColor textColorContent:(UIColor *)textColorContent titleColorButton:(UIColor *)titleColorButton backgroundColorButton:(UIColor *)backgroundColorButton backgroundColorLine:(UIColor *)backgroundColorLine;
